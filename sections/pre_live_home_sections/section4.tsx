  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12} sx={{ mt: 10,  }}>
        <Typography variant="h3" align="center" sx={{ fontSize: "5.125rem", fontWeight: 700}}>
      ...
      <Grid item container xs={12} sx={{ mt: 5, }}>
        <Grid item xs={4}>
          <CardSection4>
            ...
            <Typography variant="body1" align="left" sx={{ fontSize: "1.25rem", fontWeight: 500, color: "#4A4A4A", mt: 1}}>
