...
export default function Section2() {
  ...
  const mobileStyles = {
    ...
    marginRight: '2rem',
    fontWeight: 600,
    // Add other mobile styles as needed
};
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12}>
        ...
        >
          <Image
            ...
            height={30}
            width={200}
            style={{ filter: "grayscale(100%)", marginBottom: "1rem" }}
          />
      ...
      <Grid item xs={12}>
        <Typography
          ...
          color={"black"}
          align="center"
          style={ isMobile ? mobileStyles : nonMobileStyles }
        >
      ...
      <Grid item xs={12} sx={{ bgcolor: 'black', pb: isMobile ? "1rem" : "3.5rem", pt: "3.5rem" }}>
        <Typography variant="h3" align="center" marginTop="2rem" sx={{ color: "white", fontSize: isMobile ? "2rem" : "3rem", fontWeight: 600,  marginLeft: isMobile ? '1rem' : '0' , marginRight: isMobile ? '1rem' : '0'}}>
          "This tool is going to level the finance space for <br /> everyone."
        </Typography>
        <Typography variant="body1" align="right" marginRight="3rem" sx={{ color: "white", fontSize: isMobile ? "0.8rem" : "1.175rem", fontWeight: 550 , marginTop: isMobile ? '1rem' : '0', marginBottom: isMobile ? '1rem' : '0',   }}>
